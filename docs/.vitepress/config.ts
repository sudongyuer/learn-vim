...
function getGuideSidebar() {
  return [
    ...
    { text: 'Vim练习第十一天', link: '/guide/Vim练习第十一天'}, 
    { text: 'Vim练习第十二天', link: '/guide/Vim练习第十二天'}, 
    { text: 'Vim练习第十三天', link: '/guide/Vim练习第十三天'}, 
    { text: 'Vim练习第十四天', link: '/guide/Vim练习第十四天'}, 
    { text: 'Vim练习第十五天', link: '/guide/Vim练习第十五天'}, 
    { text: 'Vim练习第十六天', link: '/guide/Vim练习第十六天'}, 
    { text: 'Vim练习第十七天', link: '/guide/Vim练习第十七天'}, 
    { text: 'Vim练习第十八天', link: '/guide/Vim练习第十八天'}, 
  ]
}
